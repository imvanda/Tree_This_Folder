@echo off
Net session >nul 2>&1 || powershell start-process remove_treeMDorTXTorPUMLorTREE.bat -verb runas
...
del /s /q "C:\Program Files\Tree This Folder\remove_treeMDorTXTorPUMLorTree.bat"
pause
ENDLOCAL